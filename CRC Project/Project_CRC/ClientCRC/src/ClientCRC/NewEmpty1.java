...
public class NewEmpty1 extends JPanel {
  ...
  private class OpenFileChooser implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      try {
        ...
        int n = fileChooser.showOpenDialog(NewEmpty1.this);
  ...
  private class SaveFileChooser implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      try {
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setFileFilter(new TxtFileFilter());
        int n = fileChooser.showSaveDialog(NewEmpty1.this);
        if (n == JFileChooser.APPROVE_OPTION) {
          File f = fileChooser.getSelectedFile();
